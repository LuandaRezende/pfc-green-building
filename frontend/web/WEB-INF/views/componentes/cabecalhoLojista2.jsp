              ...
              <li class="nav-item dropdown position-static"><a href="<c:url value="#"/>" data-toggle="dropdown" class="nav-link dropdown-toggle">Menu</a>
                <div class="dropdown-menu megamenu py-lg-0">
                  <div class="row">
                    <div class="col-lg-9">
                      <div class="row p-3 pr-lg-0 pl-lg-5 pt-lg-5">
                        ...
                        <div class="col-lg-3">
                          ...
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="<c:url value="/lojas/novo"/>" class="megamenu-list-link">Cadastrar loja</a></li>
                            <li class="megamenu-list-item"><a href="<c:url value="/lojista/lojas"/>" class="megamenu-list-link">lojas cadastradas</a></li>
                    ...
                    <div class="col-lg-3 d-none d-lg-block"><img src="/img/photo/wikkelhouse.jpg" alt="" class="bg-image"></div>
                  </div>
                </div>
              </li>
              <!-- /Megamenu end-->
           <li class="nav-item dropdown ml-lg-3"><a id="userDropdownMenuLink" href="<c:url value="#"/>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="/img/avatar/avatar-6.jpg" alt="" class="avatar avatar-sm avatar-border-white mr-2"></a>
