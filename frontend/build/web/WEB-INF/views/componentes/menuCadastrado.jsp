                ...
                <div class="col-lg-4 col-md-5 col-sm-3 text-right fh5co-link-wrap">
                    <ul class="fh5co-special" data-offcanvass="yes">
                        <c:if test="${empty usuarioLogado}">
                            <li>
                                <a href="<c:url value=""/>" style="color:#000000">Gerenciar</a>
                            </li>
                            <li>
                                <a href="<c:url value=""/>" style="color:#000000">Logout</a>
                            </li>
                            <li>
                                <a href="<c:url value="/perfilAdm/"/>" style="color:#000000">Meus dados</a>
                            </li>  
                        </c:if>
