      ...
      <div class="row">
        <div class="col-lg-12 col-xl-12 ">
          <section class="mx-n4 mx-xl-n5 mb-4 mb-xl-5">
            ...
            <h1 class="hero-heading mb-3">Astrid Hill</h1>
          </div>
              <!-- Additional required wrapper-->
              <div class="swiper-wrapper">
                  
                <!-- Slides-->
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/astridhill1.jpg" alt="Our street" class="img-fluid"></div>
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/astridhill2.jpg" alt="Outside" class="img-fluid"></div>
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/astridhill3.jpg" alt="Rear entrance" class="img-fluid"></div>
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/astridhill4.jpg" alt="Kitchen" class="img-fluid"></div>
               </div>
