                ...
                <div class="panel col-md-5 ">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <a href="<c:url value="/recuperarSenha"/>"><button type="button" class="btn btn-link">Esqueci minha senha</button></a>
                            <br>
                        </div>
            ...
            <form class="form-validate" action="<c:url value="/login/perfil"/>" method="post">
              ...
              <div class="form-group mb-4">
                <div class="row">
                  ...
                  <div class="col-auto"><a href="<c:url value="/recuperarSenha"/>" class="form-text small">Esqueceu a senha?</a></div>
                </div>
              ...
              <!-- Submit-->
              <button class="btn btn-lg btn-primary btn-block btn-social">Entrar</button>
