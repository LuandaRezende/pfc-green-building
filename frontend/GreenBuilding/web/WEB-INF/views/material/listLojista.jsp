...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <a class="btn btn-primary" href="<c:url value="/materiais/lojista/novo"/>">Adicionar</a><br>
                    ...
                    <div class="row">
                            ...
                            <div data-marker-id="59c0c8e3503eb77d487e8082" class="col-sm-6 col-xl-4 mb-5">
                                <div class="card h-100 border-0 shadow">
                                        ...
                                        <div class="card-img-overlay-bottom z-index-20">
                                            <div class="media text-white text-sm align-items-center">
                                                <c:forEach var="contato" items="${contatos}">
                                                        <c:if test="${contato.fk_Loja_id == anuncia.fk_loja_id}">
                                                            <a href="https://wa.me/${contato.whatsapp}">
                                                                <img src="../resources/img/avatar/wpp.png" alt="Barbora" class="avatar avatar-border-white mr-2">
                                                            </a> 
                                                        </c:if>
                                                    </c:forEach>
                                                <div class="media-body">${anuncio.nome}</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <div class="w-100">
                                            <h6 class="card-title">
                                                <a href="<c:url value="detail-rooms.jsp"/>" class="text-decoration-none text-dark" id="material" name="Fk_material_id">
                                                <c:forEach var="material" items="${materiais}">
                                                    <c:if test="${material.id == anuncia.fk_material_id}">${material.nome}</c:if>
                                                </c:forEach></a></h6>
                                            <div class="d-flex flex-column card-subtitle mb-3">
                                                <p class="flex-grow-1 mb-0 text-muted text-sm">
                                                    <c:forEach var="loja" items="${lojas}">
                                                        <c:if test="${loja.id == anuncia.fk_loja_id}">${loja.nome_loja}</c:if>
                                                    </c:forEach>
                                                </p>
                                                    <c:forEach var="contato" items="${contatos}">
                                                        <c:if test="${contato.fk_Loja_id == anuncia.fk_loja_id}">
                                                            <p class="flex-grow-1 mb-0 text-muted text-sm">Fixo: ${contato.fixo}</p>
                                                            <p class="flex-grow-1 mb-0 text-muted text-sm">Celular: ${contato.celular}</p>
                                                            <p class="flex-grow-1 mb-0 text-muted text-sm">Whatsapp: ${contato.whatsapp}</p>
                                                            <p class="flex-grow-1 mb-0 text-muted text-sm">Email: ${contato.email}</p>
                                                        </c:if>
                                                    </c:forEach>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination pagination-template d-flex justify-content-center">
                                <li class="page-item"><a href="<c:url value="#"/>" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
                                <li class="page-item active"><a href="<c:url value="#"/>"  class="page-link">1</a></li>
                                <li class="page-item"><a href="<c:url value="#"/>"  class="page-link">2</a></li>
                                <li class="page-item"><a href="<c:url value="#"/>"  class="page-link">3</a></li>
                                <li class="page-item"><a href="<c:url value="#"/>"  class="page-link"> <i class="fa fa-angle-right"></i></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
