      ...
      <div class="row">
        <div class="col-lg-12 col-xl-12 ">
          <section class="mx-n4 mx-xl-n5 mb-4 mb-xl-5">
            ...
            <h1 class="hero-heading mb-3">Waste House</h1>
          </div>
              <!-- Additional required wrapper-->
              <div class="swiper-wrapper">
                  
                <!-- Slides-->
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/wastehouse.jpg" alt="Our street" class="img-fluid"></div>
                <div class="swiper-slide"><img style="height:600px;"  src="resources/img/photo/wastehouse2.jpg" alt="Outside" class="img-fluid"></div>
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/wastehouse3.jpg" alt="Rear entrance" class="img-fluid"></div>
                <div class="swiper-slide"><img style="height:600px;" src="resources/img/photo/wastehouse4.jpg" alt="Kitchen" class="img-fluid"></div>
                 </div>
